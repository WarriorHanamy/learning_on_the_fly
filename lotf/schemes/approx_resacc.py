"""ApproxResAccScheme: chirp approximation plus learned NN residual (exclusive copy)."""
...
class ApproxResAccScheme:
    """Chirp-fitted approximation with learned NN residual (exclusive copy of ApproxScheme)."""
    ...
    def integrate(
        ...
        u_delayed = delay_buffer[read_pos, jnp.arange(3)]

        omega_filtered = self._approx_K[1:] * u_delayed
