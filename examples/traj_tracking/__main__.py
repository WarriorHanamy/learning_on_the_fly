...
Usage:
    uv run python -m examples.traj_tracking train  # Train base trajectory tracking policy
    uv run python -m examples.traj_tracking eval  # Evaluate trained policy
    uv run python -m examples.traj_tracking finetune-lora  # Fine-tune policy with LoRA
    uv run python -m examples.traj_tracking finetune-full  # Fine-tune all policy parameters
"""
...
_TASKS = {
    "train": ("train_base_policy", "Train base trajectory tracking policy"),
